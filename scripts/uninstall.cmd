@echo off
:: ============================================
:: Stormworks Head Tracking - Uninstall
:: ============================================
...
set "MOD_DLLS=opengl32.dll opengl32_real.dll"
...
:: DLLs were deployed.
set "MOD_LEFTOVERS=StormworksHeadTracking.ini StormworksHeadTracking.log StormworksHeadTracking.prev.log"
